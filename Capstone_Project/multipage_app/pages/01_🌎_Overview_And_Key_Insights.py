...
#Loading DataFrames--------------------------------------------------------------------------------------------------------##
df= pd.read_parquet('../../data/movies2013-2023.parquet').drop(columns=['isAdult','characters'], axis=1)
movielens_1m = pd.read_parquet('../../data/ML1m_merged.parquet')
...
directors_revenue = pd.read_csv('../../data/directors_high_revenue.csv')
